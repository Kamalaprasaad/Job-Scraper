...
const DEFAULT_QUERIES = [
  { query: 'Automation Engineer', location: 'New Jersey' },
  { query: 'Automation Engineer', location: 'New York' },
  { query: 'Automation Engineer', location: 'Remote' },
  { query: 'Production Support Engineer', location: 'New Jersey' },
  { query: 'Production Support Engineer', location: 'New York' },
  { query: 'Production Support Engineer', location: 'Remote' },
  { query: 'DevOps Engineer', location: 'New Jersey' },
  { query: 'DevOps Engineer', location: 'New York' },
  { query: 'DevOps Engineer', location: 'Remote' },
  { query: 'Cloud DevOps Engineer', location: 'Remote' },
  { query: 'Software Engineer', location: 'New Jersey' },
  ...
  { query: 'SRE', location: 'New Jersey' },
  { query: 'SRE', location: 'Remote' },
  { query: 'Automation Test Engineer', location: 'New Jersey' },
  { query: 'Automation Test Engineer', location: 'New York' },
